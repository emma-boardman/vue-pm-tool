...
<template>
  <div class="task-detail">
    <div class="task-detail__top-bar" :style="generateClientColourClasses(task.clientName)">
      ...
      <div class="task-detail__top-bar__close-btn" @click="$emit('closeModal')">x</div>
    </div>
    <div class="task-detail__task-content">
      <p class="task-detail__task-content__task-title">
        {{ task.taskTitle }}
        <span
          class="task-detail__task-content--impact"
          :style="generateImpactColourClasses(task.taskImpact)"
        >{{ task.taskImpact}}</span>
      </p>
      <dl>
        <dt>Project</dt>
        <dd>{{ task.projectTitle }}</dd>
        <dt>Error</dt>
